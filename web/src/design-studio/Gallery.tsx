      ...
      <div className="design-studio-gallery">
        ...
        {showAbout && (
          <p className="design-studio-about">
            ...
            than this site's usual DynamoDB) as a real datastore for something that's naturally a large,
        ...
        {showHelp && (
          <div className="design-studio-help">
            <p>
              Pick a shape/text tool from the toolbar under the canvas, or press its number key (1 rectangle,
              2 ellipse, 3 arrow, 4 text). Drag to move, use the handles to resize. <kbd>Delete</kbd> removes
              the selected element, <kbd>Cmd/Ctrl+Z</kbd> undoes, <kbd>Cmd/Ctrl+Shift+Z</kbd> redoes,{" "}
